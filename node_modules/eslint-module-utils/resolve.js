...
const pkgDir = require('eslint-module-utils/pkgDir').default;
...
/** @type {import('eslint-module-utils/resolve').fileExistsWithCaseSync} */
...
/** @type {import('eslint-module-utils/types').ESLintSettings | null} */
let prevSettings = null;
let memoizedHash = '';
/** @type {(modulePath: string, sourceFile: string, settings: import('eslint-module-utils/types').ESLintSettings) => import('eslint-module-utils/resolve').ResolvedResult} */
function fullResolve(modulePath, sourceFile, settings) {
  ...
  /** @type {(resolver: import('eslint-module-utils/resolve').Resolver, config: unknown) => import('eslint-module-utils/resolve').ResolvedResult} */
...
/** @type {import('eslint-module-utils/resolve').relative} */
...
/** @type {(name: string, sourceFile: string) => import('eslint-module-utils/resolve').Resolver} */
...
/** @type {(resolver: object) => resolver is import('eslint-module-utils/resolve').Resolver} */
