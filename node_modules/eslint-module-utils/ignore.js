...
// one-shot memoized
/** @type {Set<import('eslint-module-utils/types').Extension>} */ let cachedSet;
/** @type {import('eslint-module-utils/types').ESLintSettings} */ let lastSettings;

/** @type {(context: import('eslint').Rule.RuleContext) => Set<import('eslint-module-utils/types').Extension>} */
...
/** @type {import('eslint-module-utils/ignore').getFileExtensions} */
function makeValidExtensionSet(settings) {
  // start with explicit JS-parsed extensions
  /** @type {Set<import('eslint-module-utils/types').Extension>} */
...
/** @type {import('eslint-module-utils/ignore').default} */
...
/** @type {import('eslint-module-utils/ignore').hasValidExtension} */
function hasValidExtension(path, context) {
  // eslint-disable-next-line no-extra-parens
  return validExtensions(context).has(/** @type {import('eslint-module-utils/types').Extension} */ (extname(path)));
}
