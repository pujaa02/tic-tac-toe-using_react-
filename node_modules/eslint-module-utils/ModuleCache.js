...
/** @type {import('eslint-module-utils/ModuleCache').ModuleCache} */
class ModuleCache {
  /** @param {typeof import('eslint-module-utils/ModuleCache').ModuleCache.prototype.map} map */
  constructor(map) {
    this.map = map || /** @type {{typeof import('./ModuleCache').ModuleCache.prototype.map} */ new Map();
  }

  /** @type {typeof import('eslint-module-utils/ModuleCache').ModuleCache.prototype.set} */
  set(cacheKey, result) {
  ...
  /** @type {typeof import('eslint-module-utils/ModuleCache').ModuleCache.prototype.get} */
  ...
  /** @type {typeof import('eslint-module-utils/ModuleCache').ModuleCache.getSettings} */
