import type { ClassicConfig, FlatConfig, SharedConfig } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Config';
import type { Parser } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Parser';
import type { Processor as ProcessorType } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Processor';
import type { AnyRuleCreateFunction, AnyRuleModule, RuleCreateFunction, RuleFix, RuleModule } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Rule';
