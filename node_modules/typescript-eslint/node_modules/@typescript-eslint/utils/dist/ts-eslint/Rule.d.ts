import type { JSONSchema4 } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/json-schema';
import type { ParserServices, TSESTree } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-estree';
import type { AST } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/AST';
import type { FlatConfig } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Config';
import type { Linter } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Linter';
import type { Scope } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Scope';
import type { SourceCode } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/SourceCode';
