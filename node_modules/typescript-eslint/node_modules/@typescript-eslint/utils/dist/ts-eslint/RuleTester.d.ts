import type { AST_NODE_TYPES, AST_TOKEN_TYPES } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-estree';
import type { ClassicConfig } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Config';
import type { Linter } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Linter';
import type { ParserOptions } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/ParserOptions';
import type { ReportDescriptorMessageData, RuleCreateFunction, RuleModule, SharedConfigurationSettings } from 'typescript-eslint/node_modules/@typescript-eslint/utils/src/ts-eslint/Rule';
