...
import type { ProjectServiceSettings } from 'typescript-eslint/node_modules/@typescript-eslint/typescript-estree/src/create-program/createProjectService';
import type { CanonicalPath } from 'typescript-eslint/node_modules/@typescript-eslint/typescript-estree/src/create-program/shared';
import type { TSESTree } from 'typescript-eslint/node_modules/@typescript-eslint/typescript-estree/src/ts-estree';
import type { CacheLike } from 'typescript-eslint/node_modules/@typescript-eslint/typescript-estree/src/parseSettings/ExpiringCache';
