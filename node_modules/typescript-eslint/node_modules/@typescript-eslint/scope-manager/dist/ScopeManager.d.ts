...
import type { Scope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope';
import { BlockScope, CatchScope, ClassScope, ConditionalTypeScope, ForScope, FunctionExpressionNameScope, FunctionScope, FunctionTypeScope, GlobalScope, MappedTypeScope, ModuleScope, SwitchScope, TSEnumScope, TSModuleScope, TypeScope, WithScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope';
import { ClassFieldInitializerScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/ClassFieldInitializerScope';
import { ClassStaticBlockScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/ClassStaticBlockScope';
import type { Variable } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/variable';
