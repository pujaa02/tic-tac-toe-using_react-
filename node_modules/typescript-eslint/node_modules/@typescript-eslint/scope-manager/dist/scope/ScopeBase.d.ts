...
import type { Definition } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/definition';
import type { ReferenceImplicitGlobal } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/referencer/Reference';
import { Reference, ReferenceFlag } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/referencer/Reference';
import type { ScopeManager } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/ScopeManager';
import { Variable } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/variable';
import type { FunctionScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/FunctionScope';
import type { GlobalScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/GlobalScope';
import type { ModuleScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/ModuleScope';
import type { Scope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/Scope';
import { ScopeType } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/ScopeType';
import type { TSModuleScope } from 'typescript-eslint/node_modules/@typescript-eslint/scope-manager/src/scope/TSModuleScope';
